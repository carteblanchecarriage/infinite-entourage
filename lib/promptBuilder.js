...
function buildEntouragePrompt(userPrompt, style = 'realistic') {
  ...
  // Build final prompt: framing + enhanced user prompt + surface items + object items + style + safety + context
  let fullPrompt = `${framing}, ${enhancedPrompt}${surfacePrompt}${objectPrompt}, ${styleModifier}`;
