...
const SUBJECT_PATTERNS = {
  person: {
    ...
    framingDynamic: 'full body person from head to feet, complete figure fully in frame, head to toe visible, entire body shown, frozen mid-action pose, sharp still frame, no motion blur'
  },
...
const NEGATIVE_PROMPTS = {
  realistic: 'cartoon, anime, illustration, painting, drawing, CGI, 3D render, plastic skin, clay, artificial, background, outdoor scene, indoor scene, landscape, architecture, furniture, ground, floor, text, watermark, logo, duplicate subjects, extra limbs, floating objects, blurry, motion blur, out of focus',
  illustration: 'photorealistic, photograph, cartoon, anime, manga, children\'s book style, clipart, flat icon, app icon, emoji, background scene, landscape, ground, text, watermark, extra limbs, duplicate subjects, motion blur, blurry',
  silhouette: 'color, grey, gray, gradient, texture, shading, background, scene, ground, interior detail, outline only, hollow, text, watermark, duplicate subjects, extra limbs, motion blur, blurry',
};
...
const CONTEXT_PROMPT = 'solid neutral grey background, soft diffused lighting, centered in frame, sharp focus';
