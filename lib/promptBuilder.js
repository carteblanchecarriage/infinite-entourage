...
const SUBJECT_PATTERNS = {
  ...
  plant: {
    ...
    treeFraming: 'healthy full tree with thick brown trunk, abundant spreading branches, lush green leaves and dense green foliage, vibrant green canopy, verdant healthy appearance, complete tree from base to top, no bare branches'
  },
