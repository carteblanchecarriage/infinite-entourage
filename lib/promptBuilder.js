...
const SUBJECT_PATTERNS = {
  ...
  plant: {
    ...
    treeFraming: 'full tree with thick trunk, spreading branches, lush foliage and leaves, complete canopy visible, entire tree from roots to treetop, detailed branching structure'
  },
