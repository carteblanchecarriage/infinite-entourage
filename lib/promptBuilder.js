...
const STYLE_MODIFIERS = {
  realistic: {
    ...
    default: 'photorealistic, detailed texture, natural lighting, realistic materials'
  },
...
function buildEntouragePrompt(userPrompt, style = 'realistic') {
  ...
  const framing = SUBJECT_PATTERNS[subjectType]?.framing || SUBJECT_PATTERNS.object.framing;
